...
echo -e "${GREEN}[OK] Hot channel artifacts generated${NC}"
...
echo -e "${GREEN}[OK] Cold channel artifacts generated${NC}"
echo ""
...
sleep 5
echo -e "${GREEN}[OK] Storage services started${NC}"
echo ""
...
echo -e "${GREEN}[OK] MySQL schema loaded${NC}"
echo ""
...
sleep 30
echo -e "${GREEN}[OK] Blockchains started${NC}"
echo ""
